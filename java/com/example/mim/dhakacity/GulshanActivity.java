...
import com.example.mim.dhakacity.databinding.ActivityDhanmondiBinding;
import com.example.mim.dhakacity.databinding.ActivityGulshanBinding;
...
public class GulshanActivity extends AppCompatActivity implements RestaurantAdapter.RestaurantUpdateDeleteListener {

    private ActivityGulshanBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_gulshan);
       // getSupportActionBar().setTitle(" ");
       // getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        llm=new LinearLayoutManager(this);
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        rootref= FirebaseDatabase.getInstance().getReference();
        userRef=rootref.child("Gulshan");
