...
import com.example.mim.dhakacity.databinding.ActivityPuranDhakaBinding;
...
public class PuranDhakaActivity extends AppCompatActivity implements RestaurantAdapter.RestaurantUpdateDeleteListener {
    private ActivityPuranDhakaBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_puran_dhaka);
       // getSupportActionBar().setTitle(" ");
       // getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        llm=new LinearLayoutManager(this);
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        rootref= FirebaseDatabase.getInstance().getReference();
        userRef=rootref.child("PuranDhaka");
