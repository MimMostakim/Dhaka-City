...
public class DhanmondiActivity extends AppCompatActivity implements RestaurantAdapter.RestaurantUpdateDeleteListener {

    private ActivityDhanmondiBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_dhanmondi);
       // getSupportActionBar().setTitle(" ");
       // getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        llm=new LinearLayoutManager(this);
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        rootref= FirebaseDatabase.getInstance().getReference();
        userRef=rootref.child("Dhanmondi");
