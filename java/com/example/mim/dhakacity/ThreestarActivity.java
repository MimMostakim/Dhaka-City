...
import com.example.mim.dhakacity.databinding.ActivityThreestarBinding;
...
public class ThreestarActivity extends AppCompatActivity  implements StarAdapter.HotelUpdateDeleteListener{
    private ActivityThreestarBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_threestar);
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                hotellist.clear();
                Toast.makeText(ThreestarActivity.this, "data changed", Toast.LENGTH_SHORT).show();
    ...
    public void addRestaurant(View view) {
        ...
        userRef.child(id).setValue(star).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(ThreestarActivity.this, "Saved", Toast.LENGTH_SHORT).show();
    ...
    public void viewdata(View view) {
        ...
        switch (view.getId()){
            case R.id.show3:
                startActivity(new Intent(ThreestarActivity.this,ThShowActivity.class));
                break;
        }
    }
}
