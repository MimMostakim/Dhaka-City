...
public class FoShowActivity extends AppCompatActivity implements StarAdapter.HotelUpdateDeleteListener {

    private ActivityFoShowBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_fo_show);
