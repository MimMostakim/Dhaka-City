...
import com.example.mim.dhakacity.databinding.ActivityUttaraBinding;
...
public class UttaraActivity extends AppCompatActivity implements RestaurantAdapter.RestaurantUpdateDeleteListener {
    private ActivityUttaraBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_uttara);
       // getSupportActionBar().setTitle(" ");
        //getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        llm=new LinearLayoutManager(this);
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        rootref= FirebaseDatabase.getInstance().getReference();
        userRef=rootref.child("Uttara");
